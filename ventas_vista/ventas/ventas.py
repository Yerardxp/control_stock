...
# Clase que define el comportamiento de los elementos seleccionables en la lista
...
# Clase que define el comportamiento de los elementos seleccionables en la lista (utilizada en un Popup)
...
# Clase principal que representa la lista de productos en la interfaz
class RV(RecycleView):
    def __init__(self, **kwargs):
        super(RV, self).__init__(**kwargs)
        self.data = [] # Lista que contiene los datos de los artículos en la lista
        self.modificar_producto=None # Callback para modificar productos en la lista

	# Métodos para manipular la lista de compras
...
# Clase Popup que permite buscar productos por nombre
...
# Clase Popup que permite cambiar la cantidad de un producto en la lista
...
# Clase Popup que muestra el total y permite realizar el pago
...
# Clase Popup que confirma la creación de una nueva compra
...
class VentasWindow(BoxLayout):
	...
	# Métodos para manipular la lista de compras y gestionar pagos
