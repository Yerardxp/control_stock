...
inventario=[
    {'codigo': '111', 'nombre': 'Pedigree Adulto', 'precio': 1170 , 'cantidad': 20},
    {'codigo': '222', 'nombre': 'whiskas', 'precio': 50.5 , 'cantidad': 15},
    {'codigo': '333', 'nombre': 'sieger', 'precio': 25.0 , 'cantidad': 10},
    {'codigo': '444', 'nombre': 'sabrositos', 'precio': 80.0 , 'cantidad': 20},
    {'codigo': '555', 'nombre': 'alimento de perro', 'precio': 750 , 'cantidad': 5},
    {'codigo': '666', 'nombre': 'shampoo', 'precio': 25 , 'cantidad': 25},
    {'codigo': '777', 'nombre': 'pipeta', 'precio': 35.5 , 'cantidad': 30},
    {'codigo': '888', 'nombre': 'jabon', 'precio': 65.0 , 'cantidad': 5},
    {'codigo': '999', 'nombre': 'collar', 'precio': 15.0 , 'cantidad': 10},
]
...
class SelectableBoxLayout(RecycleDataViewBehavior, BoxLayout):
    ...
    def refresh_view_attrs(self, rv, index, data):
        ...
        self.ids['_precio_por_articulo'].text= str(format(data['precio']))
        self.ids['_precio'].text = str(format(data['precio_total']))
...
class SelectableBoxLayoutPopup(RecycleDataViewBehavior, BoxLayout):
    ...
    def refresh_view_attrs(self, rv, index, data):
        ...
        self.ids['_precio'].text = str(format(data['precio']))
...
class CambiarCantidadPopup(Popup):
    ...
    def validar_input(self, texto_input):
        try:
            ...
            self.ids.notificacion_no_valido.text= 'Cantidad no valido'
...
class VentasWindow(BoxLayout):
    ...
    def pagado(self):
        self.ids.notificacion_exito.text="compra realizada"
